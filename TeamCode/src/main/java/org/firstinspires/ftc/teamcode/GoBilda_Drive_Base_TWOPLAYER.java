...
public class GoBilda_Drive_Base_TWOPLAYER extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (motorLiftLeft.getCurrentPosition() > 1400)
            {
            ...
            float Lifta; // lift up
            if (gamepad2.dpad_up == true && motorLiftLeft.getCurrentPosition() <= 2700)
            {
                Lifta = 1F; // Goes up!
            }
            else if (gamepad2.dpad_down == true && (LiftDown.getState() == false))
            {
                Lifta = -1F; //Goes down until limit switch met!
            }
            else if (gamepad2.dpad_down == false && gamepad1.dpad_up == false && LiftDown.getState() == true)
            {
            ...
            if (gamepad2.dpad_right == true && (motorExtendLeft.getCurrentPosition() <= 1400) && (motorLiftLeft.getCurrentPosition() <1000))
            {
                Extenda = 1F; // Goes up!
            }
            else if (gamepad2.dpad_right == true && (motorExtendLeft.getCurrentPosition() <= 2100) && (motorLiftLeft.getCurrentPosition() >1000))
            {
                Extenda = 1F;
            }
            else if (gamepad2.dpad_left == true && motorExtendLeft.getCurrentPosition() >= 5)
            {
                Extenda = -1F; //goes down
            }
            else if (gamepad2.dpad_right == false && gamepad2.dpad_left == false && LiftDown.getState() == true)
            {
