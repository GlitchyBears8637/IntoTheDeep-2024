...
//        sleep(1300);
        ...
        driveStraight(0.35,20,-45);
        turnToHeading(0.85,-0);
        driveStraight(0.35,15,0);
        turnToHeading(0.85,-90);
        raiseLift(1200,1);
        sleep(5000);
...
//        telemetry.update();
    ...
    public void driveStraight(double maxDriveSpeed,
        ...
        if (opModeIsActive()) {
            ...
            frontLeftTarget =  leftFront.getCurrentPosition()+ moveCounts;
            frontRightTarget =  rightFront.getCurrentPosition() + moveCounts;
            backLeftTarget =  leftBack.getCurrentPosition() + moveCounts;
            backRightTarget =  rightBack.getCurrentPosition() + moveCounts;
